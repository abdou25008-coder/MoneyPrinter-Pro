...
def reshape_arabic_if_needed(text: str) -> str:
    """
    Reshapes Arabic text so glyphs connect and render correctly right-to-left.
    Gracefully falls back to plain text if arabic_reshaper or bidi are not installed.
    """
    if not text:
        return text
...
def generate_video(
    ...
    def create_text_clip(subtitle_item):
        ...
        wrapped_txt = reshape_arabic_if_needed(wrapped_txt)
